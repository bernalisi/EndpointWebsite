  ...
  return (
    ...
    style={{ backgroundImage: `url(${background})`}}>
      ...
      <motion.div variants={ParentVariations} initial="hidden" animate="visible" className="w-screen h-screen mt-[60px] lg:mt-[100px] px-2 sm:px-6 lg:px-8 pt-32 pb-[333px] flex max-md:items-center max-sm:justify-end items-start flex-col gap-6">
        {/* First paragraph */}
        <motion.h1 variants={ChildVariations} initial="hidden" animate="visible" className="w-[100%] lg:w-[65%] xl:w-[60%] text-white px-4 xl:text-[60px] lg:text-[50px] md:text-[60px] sm:text-[50px] text-[40px] max-sm:text-left max-md:text-center font-semibold leading-tight">Instantly find RWD for smarter pharmaceutical research</motion.h1>
        ...
        Our self-service platform enables quick discovery and access to curated healthcare data from leading organizations worldwide, streamlining research and data analysis for observational studies with just a few clicks.</motion.a>
