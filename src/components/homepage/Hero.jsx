    ...
    >
      ...
      >
        ...
        <motion.h1
          ...
          initial="hidden"
          animate="visible"
          className="w-[100%] lg:w-[65%] xl:w-[60%] ld:text-[120px] text-white px-4 xl:text-[60px] lg:text-[50px] md:text-[60px] sm:text-[50px] text-[40px] max-sm:text-left max-md:text-center font-semibold leading-tight"
        >
        ...
        <motion.a
          ...
          initial="hidden"
          animate="visible"
          className="w-[75%] md:w-[90%] lg:w-[60%] xl:w-[55%] ld:text-[35px] px-4 max-sm:hidden max-md:text-center text-white lg:text-[15px] xl:text-[20px] md:text-[20px] sm:text-[15px] font-normal pt-5 leading-relaxed"
        >
