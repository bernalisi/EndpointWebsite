  ...
  return (
    ...
    style={{ backgroundImage: `url(${background})`}}>
      ...
      <motion.div variants={ParentVariations} initial="hidden" animate="visible" className="w-screen h-screen mt-[60px] lg:mt-[100px] px-2 sm:px-6 lg:px-14 xl:px-52 pt-32 pb-[333px] flex max-md:items-center max-sm:justify-end items-end flex-col gap-6">
        {/* First paragraph */}
        <motion.h1 variants={ChildVariations} initial="hidden" animate="visible" className="w-[100%] lg:w-[40%] xl:w-[50%] text-white px-4 xl:text-[80px] lg:text-[50px] md:text-[60px] sm:text-[50px] xl:mb-16 text-[40px] max-sm:text-left max-md:text-center font-semibold leading-tight">Healthcare Providers</motion.h1>
        ...
        Securely share, control, and monetize your healthcare data to advance medical research with Endpoint</motion.a>
