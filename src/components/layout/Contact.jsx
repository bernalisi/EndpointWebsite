...
export default function Contact() {
  return (
    <div
      className="bg-cover bg-center bg-no-repeat w-full h-screen flex flex-col justify-start items-start gap-4 px-6 mb-20 sm:px-10 lg:px-14 pt-10 sm:pt-16 lg:pt-20"
