...
export default function MobileNavbar() {
  ...
  const menuClosed = (
    <div className="absolute w-full h-16 z-50">
      <nav
        ...
        className={
          scrolling || hovering
            ? "fixed bg-white top-0 w-full h-16 flex items-center justify-between border-white px-6"
      ...
      >
        ...
        <div className="flex flex-row gap-4">
          <img
            src={scrolling || hovering ? Menu_option_black : Menu_option_white}
  ...
  return <>{menuOpen ? menuOpened : menuClosed}</>;
}
