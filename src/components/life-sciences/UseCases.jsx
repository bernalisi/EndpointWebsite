...
export default function Why() {
  ...
  return (
    <div className="w-full h-auto pb-10 lg:h-[1400px] bg-white flex flex-col justify-start xl:justify-start items-start gap-4 px-4 sm:px-10 lg:px-14 pt-10 sm:pt-16 xl:mt-10">
      ...
      <div className="flex flex-col xl:flex-row justify-start gap-10 w-full">
        {/* Navigation */}
        <div className="w-full xl:w-[15%] mt-10 flex-wrap xl:mt-20 flex flex-row xl:flex-col justify-start text-left items-start ">
            ...
            <button
              ...
              className={
                defaultUseCase === Number(key)
                  ? "border-l-4 border-violet-900 text-left text-violet-900 py-4 px-2 sm:px-4 w-full text-sm sm:text-base"
