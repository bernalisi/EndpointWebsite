...
export default function Why() {
  ...
  return (
    <div className="w-full h-full bg-white flex flex-col justify-start xl:justify-start items-start gap-4 px-6 sm:px-10 lg:px-14 pt-10 sm:pt-16 xl:mt-10">
      <SectionSeparator TitleSection="EXPLORE OUR USE CASES" />

      <div className="flex flex-row justify-start gap-10">
        <div className="w-[15%] h-[900px] mt-20 flex-col justify-start items-start gap-3">
          {/* Navigation */}
            ...
            <button
              ...
              className={
                defaultUseCase === Number(key)
                  ? "border-l-4 border-violet-900 text-violet-900 py-2 px-4"
                  : "border-l-4 hover:border-violet-900 hover:text-violet-900 py-2 px-4"
              }
            >
