...
export default function UseCase({ defaultUseCase }) {
  ...
  return (
    <div className="w-[85%] h-[800px] overflow-y-scroll flex flex-col justify-start items-start bg-white border-[1.5px] border-black mt-20">
      {/* Use Case */}
      ...
      <div className="m-7 flex flex-row justify-start items-start gap-10">
        <p className="text-violet-900 text-[24px] font-medium">
      ...
      <p className="m-7 px-4 py-1 text-[24px] text-black rounded-full font-bold">
