...
export default function UseCase({ defaultUseCase }) {
  ...
  return (
    <div className="w-full xl:w-[85%] h-[550px] lg:h-[1000px] xl:h-[1300px] xl:pb-50 overflow-y-scroll flex flex-col justify-start items-start bg-white border-[1.5px] border-gray-200 mt-10 xl:mt-20 px-4 sm:px-7 shadow-lg">
      {/* Use Case Title */}
