...
export default function SectionSeparator({TitleSection}) {
  ...
  return (
    <div className="flex flex-row justify-start items-center gap-2">
      ...
      <motion.h6 variants={TextVariant} initial="hidden" whileInView="show" viewport={{margin: '-100px', once: true,}} className="text-white text-sm sm:text-base">{TitleSection}</motion.h6>
    </div>
  )
}
